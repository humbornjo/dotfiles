return function(_, _)
  ...
  local setup_servers = function()
    vim.tbl_map(require("user.utils.lsp").setup, astronvim.user_opts "lsp.servers")
    vim.api.nvim_exec_autocmds("FileType", {})
    require("user.utils").event "LspSetup"
  end
  if require("user.utils").is_available "mason-lspconfig.nvim" then
